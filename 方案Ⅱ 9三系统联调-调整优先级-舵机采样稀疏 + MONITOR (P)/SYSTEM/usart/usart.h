...
extern u8 USART2_RX_BUF[USART_REC_LEN]; //串口2接收缓冲,最大USART_REC_LEN个字节
extern u16 USART2_RX_STA;     //串口2接收状态标记

extern u8 USART3_RX_BUF[USART_REC_LEN]; //串口2接收缓冲,最大USART_REC_LEN个字节
extern u16 USART3_RX_STA;     //串口2接收状态标记

extern u8 UART4_RX_BUF[USART_REC_LEN];  
extern u16 UART4_RX_STA; 

extern u32 Monitor_Distance;  
extern u32 A_Distance;
extern u32 A_statue;
